<table width="700px" height="570px" style="font-size:14px;margin:0 auto;border:1px solid">
    ...
    <tr>
        <td style="padding:0px 64px;font-size:14px">您在{{$siteName}}进行了找回密码的操作，您的账号名为：{{$username}}<br/>请点击链接重置密码：<h4
                    style="color:#ff0000"><a href="{{$url}}">{{$url}}</a></h4>请登录{{$siteName}}官网，并及时在个人中心修改您的新密码。
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="padding:10px 60px 80px;border-top:1px solid #ededed;color:#959393;font-size:14px">
            如您错误的收到了此邮件，请不要点击激活按钮，该帐号将不会被启用。<br/>这是一封系统自动发出的邮件，请不要直接回复，如您有任何疑问，请联系客服
        </td>
    </tr>
</table>