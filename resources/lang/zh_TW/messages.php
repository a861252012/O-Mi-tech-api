...
return [
    ...
    'GuardianService.remind_msg' => '守護:payType提醒：您已成功開通 :levelName ，到期日： :expireDate',
    ...
    'Activity.detailtype.wrong_id' => '活動id錯誤',
    'Activity.detailtype.empty_url' => '未設定url路徑',
    ...
    'Member.transfer.send_reminder_msg' => '您成功轉出:points鑽石到:username帳戶',
    'Member.transfer.receive_reminder_msg' => '您成功收到由 :sender 轉到您帳戶 :points 鑽石',
    ...
    'Member.redEnvelopeSend.send_later' => '延遲傳送',
    'Member.redEnvelopeSend.wait_for_refund' => '已結束待退鑽',
    'Member.redEnvelopeSend.is_sending' => '傳送中',
    'Member.redEnvelopeSend.done' => '已結束',
    ...
    'V2Ath.HTTP_ERROR_401' => '未授權的請求，請重啟應用後再嘗試',
    'V2Ath.HTTP_ERROR_403' => '拒絕存取',
    'V2Ath.HTTP_ERROR_410' => '驗證碼已逾期，請重啟應用後再嘗試',
    ...
    'goods.category_id.6' => '熱門情趣',
    'goods.category_id.7' => '約會聽歌',
    'goods.category_id.8' => '奢華寵愛',
    ...
    'FirstChargeService.reminder_msg' => '恭喜你獲得首充豪禮，貴族體驗券、等級積分、反饋鑽石、飛頻均已傳送，若有問題請洽客服人員。',
    'Crontab.vipNearExpInfo' => '貴族保級即將失敗提醒：您的貴族即將到期！請儘快充值保級！',
    'Crontab.vipNearExpInfo.reminder_msg' => '貴族保級即將失敗提醒：您的:level_name貴族到期日： :vip_end ！請儘快充值保級！',
    'ShareRewardNotification.reminder_msg' => '恭喜你邀請的使用者 ID :invited_uid，完成了手機驗證。獲得了5個鑽石獎勵。',
    ...
    'BackPackService.useVip.expire_remind' => '親愛的使用者，您的 :vip_name 將從 :start_date 至 :end_date',
    'Roulette.setting.is_off' => '輪盤遊戲未開啟',
    'RouletteItem.type.1' => '鑽石',
    'RouletteItem.type.2' => '經驗值',
    'RouletteItem.type.3' => '金尊體驗券',
    'RouletteItem.type.4' => '紅尊體驗券',
    'RouletteItem.type.5' => '藍尊體驗券',
    'RouletteItem.type.6' => '青尊體驗券',
    'RouletteItem.type.7' => '綠尊體驗券',
    'RouletteItem.type.8' => '墨尊體驗券',
    'RouletteItem.type.9' => '白尊體驗券',
    'RouletteItem.type.10' => '神祕大獎',
    'Roulette.play.room_id_error' => '房間ID輸入錯誤',
    'Roulette.play.count_error' => '次數輸入錯誤',
    'Roulette.play.not_enough_free_or_points' => '免費票或鑽石不足',
    'Roulette.play.failed' => '抽獎失敗',
    'Roulette.getHistory.date_range_error' => '時間區間錯誤',
    'item.1' => '白尊體驗券',
    'item.2' => '火箭飛屏',
    'item.3' => '金尊體驗券',
    'item.4' => '紅尊體驗券',
    ...
    'item.7' => '綠尊體驗券',
    'item.8' => '墨尊體驗券',
    'BackPackService.useVip.expire_remind.30' => '白尊體驗',
    'BackPackService.useVip.expire_remind.31' => '墨尊體驗',
    'BackPackService.useVip.expire_remind.32' => '綠尊體驗',
    'BackPackService.useVip.expire_remind.33' => '青尊體驗',
    'BackPackService.useVip.expire_remind.34' => '藍尊體驗',
    'BackPackService.useVip.expire_remind.35' => '紅尊體驗',
    'BackPackService.useVip.expire_remind.36' => '金尊體驗',
];
