...
return [
    ...
    'SmsService.register_msg_verify' =>'验证码：「{{code}}」，注册验证码，请您尽快完成注册。【玉夕郎商贸】',
    'SmsService.login_msg_verify' =>'验证码：「{{code}}」，您的登录验证码。【玉夕郎商贸】',
    'SmsService.reset_pwd_msg_verify' =>'验证码：「{{code}}」，用于密码找回。【玉夕郎商贸】',
    'SmsService.reset_phone_msg_verify' =>'验证码：「{{code}}」，用于手机号变更。【玉夕郎商贸】',
