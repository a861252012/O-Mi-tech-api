...
return [
    ...
    'Guardian.name.1' => '黄色守护',
    'Guardian.name.2' => '紫色守护',
    'Guardian.name.3' => '黑色守护',
    ...
    'GuardianService.remind_msg' => '守护:payType提醒：您已成功开通 :levelName ，到期日： :expireDate',
    ...
    'Api.platform.empty_nickname' => '接入方用户名为空',
    ...
    'Api.platform.room_does_not_exist' => '房间不存在',
    ...
    'Password.changePwd.illegal_username' => '用户名不合法',
    ...
    'Member.buyVip.first' => '您首次开通 :level_name 贵族，获得了赠送礼包的 :gift_money 钻石',
    'Member.buyVip.pass' => '贵族开通成功提醒：您已成功开通 :level_name 贵族，到期日： :exp ',
    ...
    'Member.redEnvelopeSend.send_later' => '延迟发送',
    'Member.redEnvelopeSend.wait_for_refund' => '已结束待退钻',
    'Member.redEnvelopeSend.is_sending' => '发送中',
    'Member.redEnvelopeSend.done' => '已结束',
    ...
    'Other.createHomeOneToManyList.create_room_successfully' => '创建直播间一对多数据成功',
    'SiteService.check_domain' =>'域名配置错误，请联系客服！',
    'SiteService.check_site_config' =>'站点配置缺失，请联系客服！',
    'SocketService.out_of_channel' =>'没有可用channel',
    'SocketService.failed_tp_get_socket' =>'获取Socket Channel失败',
    'SmsService.try_again_later' =>'刚刚已发送过，请稍后再试',
    'SmsService.curlPost_error' =>'请求状态错误，HTTP error:  ',
    'V2Ath.HTTP_ERROR_401' => '未授权的请求，请重啟应用后再尝试',
    'V2Ath.HTTP_ERROR_403' => '拒绝存取',
    'V2Ath.HTTP_ERROR_410' => '验证码已逾期，请重啟应用后再尝试',
    ...
    'ShareInstallLogRequest.scode' => '输入分享码不正確',
    ...
    'goods.category_id.3' => '高级',
    'goods.category_id.4' => '奢华',
    'goods.category_id.5' => '贵族',
    'goods.category_id.6' => '热门情趣',
    'goods.category_id.7' => '约会听歌',
    'goods.category_id.8' => '奢华宠爱',
    'user.ViplevelName.1101' => '七品白尊',
    'user.ViplevelName.1102' => '六品墨尊',
    'user.ViplevelName.1103' => '五品绿尊',
    'user.ViplevelName.1104' => '四品青尊',
    'user.ViplevelName.1105' => '三品蓝尊',
    'user.ViplevelName.1106' => '二品红尊',
    'user.ViplevelName.1107' => '一品金尊',
    'FirstChargeService.reminder_msg' => '恭喜你获得首充豪礼，贵族体验券、等级积分、反馈钻石、飞频均已发送，若有问题请洽客服人员。',
    'Crontab.vipNearExpInfo' => '贵族保级即将失败提醒：您的贵族即将到期！请尽快充值保级！',
    'Crontab.vipNearExpInfo.reminder_msg' => '贵族保级即将失败提醒：您的:level_name贵族到期日： :vip_end ！请尽快充值保级！',
    ...
    'RouletteItem.type.3' => '金尊体验券',
    'RouletteItem.type.4' => '红尊体验券',
    'RouletteItem.type.5' => '蓝尊体验券',
    'RouletteItem.type.6' => '青尊体验券',
    'RouletteItem.type.7' => '绿尊体验券',
