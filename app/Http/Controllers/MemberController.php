...
//            DB::table((new Users)->getTable())->where('uid', $userTo['uid'])->increment('points', $points);
     ...
     * @apiSuccess {String} msg 回傳訊息
     * @apiSuccess {Object} data
     * @apiSuccess {Int} data.lv_sub 當前已獲得的經驗值
     * @apiSuccess {Int} data.lv_next_exp 下一等級所需的經驗值
     * @apiSuccess {Int} data.lv_current_exp 當前等級所需的經驗值
     * @apiSuccess {Int} data.lv_percent 當前等級的經驗百分比
     * @apiSuccess {Int} data.uid 用戶uid
     * @apiSuccess {Int} data.lv_exp 主播當前的經驗等級
     *
     ...
     */
    public function getAnchorLevelInfo()
    {
        $data = resolve(UserGroupService::class)->getAnchorLevelInfo(Auth::user());
