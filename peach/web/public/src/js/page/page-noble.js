$(function(){
    ...
    Noble.getNobleAllInfo(function(data){
        ...
        for(var i = 0; i<info.length; i++) {
            ...
            allowstealth.push('<td>'+ permission['allowstealth'] +'</td>');
        }

        table = [levelName,open,icon,openMoney,giftmoney,gmountName,allowVisitRoom,modNickname,hasWelcome,hasChatEffect,chatSecond,hasVipSeat,noChat,noChatLimit,avoidOut,letOut,allowstealth];
