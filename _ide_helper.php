...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
        ...
        {
            //Method inherited from \Illuminate\Auth\SessionGuard
            return \App\Services\Auth\SessionGuard::logoutOtherDevices($password, $attribute);
        }
...
namespace App\Facades {
    ...
    class SiteSer {
        ...
        {
            return \App\Services\Site\SiteService::getConfigBySiteID($id);
        }
         ...
         * @static
         */
        public static function getDBConfigArrayForSite($site)
        {
    ...
    class UserSer {
         ...
         * @param int $perPage
         * @Author nicholas
         * @return \App\Services\User\LengthAwarePaginator
         * @static
         */
    ...
    class Mobile {
         ...
         * @static
         */
        public static function getLastIosVersion($verCode = '', $branch = '')
        {
            return \App\Services\Mobile\MobileService::getLastIosVersion($verCode, $branch);
        }
         ...
         * @static
         */
        public static function getLastAndroidVersion($verCode = "", $branch = '')
        {
            return \App\Services\Mobile\MobileService::getLastAndroidVersion($verCode, $branch);
        }
